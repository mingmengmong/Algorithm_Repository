...
public class BOJ17141 {
	...
	public static void BOJ17141(String[] args) throws Exception {
...
//		System.out.println(virusList);
		...
		makeCombList(0, 0, virusList.size(), new int[M]);
...
//		System.out.println(cnt);
	...
	public static boolean[][] getBooleanArr(){
